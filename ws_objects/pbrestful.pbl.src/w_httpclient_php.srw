...
type cb_20 from commandbutton within w_httpclient_php
end type
...
string text = "访问12Mjson数据"
end type

event clicked;HttpClient client
...
k0=CPU()
client.autoreaddata = true
r=client.SendRequest("GET","http://192.0.0.68:8010/ModelStore/order/query?StartDate=8/25/2013 00:00:00&EndDate=5/24/2018 23:59:59&CustomerId=0" )

string json

client.GetResponseBody(json)
ll_num = FileOpen("json.txt", StreamMode!, Write!, LockWrite!, Replace!)	
FileWriteEx(ll_num, blob(json))
FileClose(ll_Num)
k1=CPU()

MessageBox("msg",string(k1 - k0) + " ~r~n Save to file:json.txt")
...
ls_Url = is_ip + "/restful/class/2?name=SAP22"
